...
const [activeTab, setActiveTab] = useState('Signup');
  return (
    <View className="p-6 bg-white w-80 h-96 rounded-2xl shadow-md">
      ...
      <TextInput
        className="border border-gray-300 p-3 mb-3 rounded mt-4"
      ...
      <TouchableOpacity className="bg-blue-600 p-3 rounded mt-2"  onPress={() => Alert.alert('Welcome', 'You tapped the button!')}>
